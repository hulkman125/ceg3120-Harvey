...
void floppy_detect_drives() {
    ...
    print(" - Floppy drive 0: ");

    print(drive_types[drives >> 4]);
    print("\n");
    print(" - Floppy drive 1: ");
    print(drive_types[drives & 0xf]);
    print("\n");
